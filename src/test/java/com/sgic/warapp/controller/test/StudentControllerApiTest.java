...
public class StudentControllerApiTest {
	...
	public void saveStudent() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/api/student").content(asJsonString(new Student("jim", 22)))
	...
	public void getOneStudent() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/api/student/{id}", 22).accept(MediaType.APPLICATION_JSON))
				.andDo(print()).andExpect(status().isOk());
	}

	@Test
	public void getAllStudents() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/api/students").accept(MediaType.APPLICATION_JSON)).andDo(print())
				.andExpect(status().isOk());
	}
